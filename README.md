...
## 🌐 Despliegue
La aplicación está configurada para exportación estática, lo que permite alojarla en:
- **GitHub Pages** (vía GitHub Actions configurado en `.github/workflows/deploy.yml`)
- **Vercel**
